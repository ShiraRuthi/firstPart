...
public class ShadowTest {
	...
	public void SphereTriangleMove1() {
		...
		scene.addGeometries(new Sphere(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
				60, new Point3D(0, 0, 200)), //
				new Triangle(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
						new Point3D(-20, 40, 0), new Point3D(-20, 70, 0), new Point3D(-50, 68, 4)));
	...
	public void SphereTriangleMove2() {
		...
		scene.addGeometries(new Sphere(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
				60, new Point3D(0, 0, 200)), //
				new Triangle(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
						new Point3D(-10, 40, 0), new Point3D(20, 70, 0), new Point3D(-68, 68, 4)));
	...
	public void SphereTriangleSpot1() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0), //
				new Point3D(-200, 100, -400), new Vector(1, -1, 3), 1, 1E-5, 1.5E-7));
	...
	public void SphereTriangleSpot2() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0), //
				new Point3D(-50, 100, -70), new Vector(1, -1, 3), 1, 1E-5, 1.5E-7));
