 ...
 */
     ...
     * @param vertices
     */
    public Polygon(Color _color ,Point3D... vertices) {
        super(_color);
        helpCtor(vertices);
        }
    /**
     ...
     * @param vertices
     */
    public Polygon(Material _material,Color _color ,Point3D... vertices) {
     ...
     * @param _color - get the object color
    ...
    public void helpCtor(Point3D... vertices)
    {
